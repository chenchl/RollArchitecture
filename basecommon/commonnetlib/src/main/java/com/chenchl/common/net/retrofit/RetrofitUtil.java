...
import com.chenchl.common.net.bean.IModel;
import com.chenchl.common.net.cookie.CookieJarImpl;
import com.chenchl.common.net.cookie.MemoryCookieStore;
...
public class RetrofitUtil {
     ...
     * @return
     */
    public static <T extends BaseModel> FlowableTransformer<T, T> getDefaultTransformer() {
                        ...
                        if (!model.isSuccess()) {
                            switch (model.getCode()) {
                                case NetError.ServerError:
                                    return Flowable.error(new NetError(model.getMsg(), NetError.ServerError));
                                case NetError.NoLogin:
                                    return Flowable.error(new NetError(model.getMsg(), NetError.NoLogin));
                                case NetError.OthrerDevice:
                                    return Flowable.error(new NetError(model.getMsg(), NetError.OthrerDevice));
                                default:
